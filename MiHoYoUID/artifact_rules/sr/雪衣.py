...
CHARACTER_NAME = '雪衣'
BASE_WEIGHT: Dict[str, float] = {'hp': 0.0, 'atk': 75.0, 'def': 0.0, 'speed': 100.0, 'cpct': 100.0, 'cdmg': 100.0, 'stance': 100.0, 'heal': 0.0, 'recharge': 50.0, 'effPct': 0.0, 'effDef': 0.0, 'dmg': 100.0}
