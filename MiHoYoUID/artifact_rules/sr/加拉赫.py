...
CHARACTER_NAME = '加拉赫'
BASE_WEIGHT: Dict[str, float] = {'hp': 75.0, 'atk': 0.0, 'def': 75.0, 'speed': 100.0, 'cpct': 0.0, 'cdmg': 0.0, 'stance': 100.0, 'heal': 100.0, 'recharge': 75.0, 'effPct': 0.0, 'effDef': 50.0, 'dmg': 0.0}
