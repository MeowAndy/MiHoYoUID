...
CHARACTER_NAME = '艾丝妲'
BASE_WEIGHT: Dict[str, float] = {'hp': 0.0, 'atk': 75.0, 'def': 0.0, 'speed': 100.0, 'cpct': 75.0, 'cdmg': 75.0, 'stance': 100.0, 'heal': 0.0, 'recharge': 100.0, 'effPct': 0.0, 'effDef': 0.0, 'dmg': 100.0}
