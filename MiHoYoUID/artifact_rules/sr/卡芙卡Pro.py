...
CHARACTER_NAME = '卡芙卡Pro'
BASE_WEIGHT: Dict[str, float] = {'hp': 0.0, 'atk': 100.0, 'def': 0.0, 'speed': 100.0, 'cpct': 0.0, 'cdmg': 0.0, 'stance': 50.0, 'heal': 0.0, 'recharge': 50.0, 'effPct': 75.0, 'effDef': 0.0, 'dmg': 100.0}
