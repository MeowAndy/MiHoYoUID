...
CHARACTER_NAME = '刻律德菈'
BASE_WEIGHT: Dict[str, float] = {'hp': 0.0, 'atk': 100.0, 'def': 0.0, 'speed': 100.0, 'cpct': 0.0, 'cdmg': 100.0, 'stance': 0.0, 'heal': 0.0, 'recharge': 100.0, 'effPct': 0.0, 'effDef': 0.0, 'dmg': 100.0}
