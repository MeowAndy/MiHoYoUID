...
CHARACTER_NAME = '飞霄'
BASE_WEIGHT: Dict[str, float] = {'hp': 0.0, 'atk': 75.0, 'def': 0.0, 'speed': 75.0, 'cpct': 100.0, 'cdmg': 100.0, 'stance': 0.0, 'heal': 0.0, 'recharge': 100.0, 'effPct': 0.0, 'effDef': 0.0, 'dmg': 100.0}
