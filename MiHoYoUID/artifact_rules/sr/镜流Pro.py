...
CHARACTER_NAME = '镜流Pro'
BASE_WEIGHT: Dict[str, float] = {'hp': 100.0, 'atk': 0.0, 'def': 0.0, 'speed': 100.0, 'cpct': 100.0, 'cdmg': 100.0, 'stance': 0.0, 'heal': 0.0, 'recharge': 50.0, 'effPct': 0.0, 'effDef': 0.0, 'dmg': 100.0}
