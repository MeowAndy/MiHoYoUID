...
CHARACTER_NAME = '风堇'
BASE_WEIGHT: Dict[str, float] = {'hp': 100.0, 'atk': 0.0, 'def': 0.0, 'speed': 100.0, 'cpct': 0.0, 'cdmg': 75.0, 'stance': 0.0, 'heal': 100.0, 'recharge': 100.0, 'effPct': 0.0, 'effDef': 50.0, 'dmg': 0.0}
